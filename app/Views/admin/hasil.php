                    ...
                    <td style="text-align:center;">
                        ...
                        <?php
                            foreach ($materi as $km) {
                                echo " <div><a target='_blank' href='".base_url()."/admin/users/hasilexcel/$user_id/".$km->materi_id."'>Excel ".$km->materi_nm."</a> | <a target='_blank' href='".base_url() ."/admin/users/hasilweb/$user_id/".$km->materi_id."'>Web ".$km->materi_nm."</a></div>";
