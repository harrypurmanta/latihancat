            ...
            if ($no_soal == $max_no_soal && $group_id == 1) {
                ...
                if ($class_soal == "Sikap Kerja" || $class_soal == "petunjuksikapkerja") {
                    ...
                    $ret = "<div class='col-lg-12'>
                        ...
                        <tr style='font-size:25px;border-bottom:1px solid black;height: 100px;'><td>Kecerdasan</td><td width='50' style='text-align:center;'>:</td><td width='80' style='text-align:center;'><label>".ceil($benar_kec)."</label></td><td width='80' style='text-align:center;color:red;'><label>".ceil($salah_kec)."</label></td></tr>
